...
class StaticFeed extends ServerBase
{
    ...
    getFeed() 
    {
        ...
        var sourceThrottleRate = Math.floor(fs.statSync(source)['size'] / 
                                        this.options.video_duration);
        console.log("Generate a throttle rate of %s kBps", 
