...
public class VisionTrackerActivity extends Activity
        implements RobotConnectionStateListener, RobotEventListener, SensorEventListener
{
    ...
    private Sensor m_gameOrientation;
...
//        }
    ...
    public void onSensorChanged(SensorEvent event)
    {
        ...
        {
            // values are measured as sin(theta/2) for each axis
            Log.i("SensorChanged", String.format(Locale.US, "%g %g %g",
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m_gameOrientation = m_sensorManager.getDefaultSensor(Sensor.TYPE_GAME_ROTATION_VECTOR);
    ...
    protected void onResume() {
        ...
        mIsRunning = true;
        m_sensorManager.registerListener(this, m_gameOrientation, SensorManager.SENSOR_DELAY_GAME);
    }
